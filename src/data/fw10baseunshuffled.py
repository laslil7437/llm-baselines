...
FINEWEB10_DATA_PATH = os.path.join(os.path.dirname(__file__), "datasets/fineweb10baseunshuffled/")

tknzr = tiktoken.get_encoding("gpt2")

def get_fineweb10baseunshuffled_data(num_proc=40):
    ...
    if not os.path.exists(os.path.join(FINEWEB10_DATA_PATH, "train.bin")):
        ...
        split_dataset = dataset["train"].train_test_split(
            test_size=0.1, seed=2357, shuffle=False
        )
