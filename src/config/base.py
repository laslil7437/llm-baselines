...
def parse_args(base_parser, args, namespace):
    ...
    # Dataset params
    parser.add_argument('--dataset', default='slimpajama', choices=['slimpajama', 'wikitext', "shakespeare-char", 'openwebtext2', 'fineweb10', 'finewebmini', 'fineweb10base', 'fineweb10shuffled', 'fineweb10domains', 'fw10baseunshuffled', 'fineweb10eot'])
